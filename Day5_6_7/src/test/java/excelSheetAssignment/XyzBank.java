...
import static org.testng.Assert.assertEquals;import java.util.List;import org.openqa.selenium.By;
...
public class XyzBank { WebDriver wd; @BeforeClass
public void BeforeMethod() throws Exception {
System.setProperty("webdriver.chrome.driver",
"D:\\chromedriver_win32\\chromedriver.exe");
wd = new ChromeDriver(); wd.navigate().to("http://www.way2automation.com/angularjs-protractor/banking/#/login");
...
Thread.sleep(1000);
//to print the transaction from webtable
...
wd.switchTo().alert().accept();
//CUSTOMER TABLE
System.out.println("----------- Customer Table -------------"); wd.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/div[1]/button[3]")).click();
Thread.sleep(1000); WebElement tab2 = wd.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/div[2]/div/div/table"));
